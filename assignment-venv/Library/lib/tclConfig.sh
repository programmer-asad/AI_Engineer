...
# installed.
TCL_PREFIX='D:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library\include'
...
TCL_PACKAGE_PATH='D:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Data_Science_and_Machine_Learning/04-AI Engineer/Assignment/Assignment_on_Module-07/assignment-venv\Library\lib\tclstub86.lib'
